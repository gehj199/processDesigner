...
define(function (require, exports, module) {
  ...
  BoundaryEventShape.getProperty = function (designer, options) {
    ...
    var attributes=[{
      ...
      "name": 'cancelActivity',
      "hidden":(eventDefinition=='timerEventDefinition')?false:true,
      "value": "true",
      "editor": {
        "type": "checkbox"
      }
  ...
  BoundaryEventShape.beforeExport = function(designer, node, json, attributes){
    if(node.parent){
      ...
      if(json.children&& json.children[0].name=='compensateEventDefinition')
        json.children[0].attributes[2].value=node.parent.getData('nodeId');
    }
  };
});
