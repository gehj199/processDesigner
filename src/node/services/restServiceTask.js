...
define(function (require, exports, module) {
  ...
  var restServiceTaskShape = kity.createClass('restServiceTaskShape', {
    ...
    create: function (node) {
     ...
     var text = new kity.Path().stroke(node.getStyle('normal-stroke'), 1);
    ...
    doUpdate: function (outlineGroup, node, box) {
      ...
      cir.getDrawer().clear()
        ...
        if(node.data && node.data.property){
          var compensate=shapes[3];
          var compen=node.data.property.attributes[4].value;
          ...
          if(compen=="true"){
             ...
             compensate.setAttr('transform', 'translate(-20, -1)');
           }else{
             compensate.getDrawer().clear()
           }
         }
