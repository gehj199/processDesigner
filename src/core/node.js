...
define(function (require, exports, module) {
  ...
  var DesignerNode = kity.createClass('DesignerNode', {
    ...
    insertLeaves: function (node, index) {
      if (utils.isNil(index)) {
        index = this.processChild.length;
      }
      if (node.parent) {
        node.parent.removeChild(node);
      }
      this.processChild.push(node);
      return this;
    },
  ...
  kity.extendClass(Designer, {
    ...
    removeNode: function (node, excludeLines) {
      ...
      if(node.processChild){
        var designer=node.designer;
        node.processChild.forEach(function(child,i){
          designer.removeNode(child);
        });
      }
      return this;
    },
