...
define(function (require, module, exports) {
  ...
  DesignerLine.register('inflectionLockable', function (line) {
    ...
    if(line&& line.data && line.data.property&& line.data.property.attributes&&line.data.property.attributes[8]&&line.data.property.attributes[8].value&&line.data.property.attributes[8].value=='None')
      line.isArrow=false;
    else
      line.isArrow=true;
    if(line.isArrow===true){
